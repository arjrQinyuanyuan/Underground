...
public class DateUtils {
    ...
    public static Date offset(final Date asOfDate, final CarInsuranceDuration duration) {
     ...
     * @return
     */
    public static LocalDate offset(LocalDate asOfDate, CarInsuranceDuration duration) {
